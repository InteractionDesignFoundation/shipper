<template>
  <section :disabled="createdRelease">
    ...
    <p>
      Please write clean/meaningful changelogs so that non-technical staff can
      also read and understand it. Example:
    </p>

    <ul>
      <li>
        <code>
          - ⭐ Associate Bootcamp with Course and BootcampEnrolment with
          CourseEnrolment</code
        >
      </li>
      <li><code> - ✨ Hide search bar from Installments Nova panel</code></li>
      <li>
        <code>
          - 🐞 Fix Masterclass record purchase when paid throguh PayPal</code
        >
      </li>
    </ul>

    <p>
      Please mark all technical changes with the ⚙️ emoji, so that
      non-developers know to ignore them. Example: <br />
    ...
    <form @submit.prevent="createRelease">
      ...
      <div class="field">
        ...
        />
        <small
          >Feel free to change autogenerated text to adapt it for
