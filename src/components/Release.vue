<template>
  <section :disabled="createdRelease">
    ...
    <p>
      <a href="https://github.com/InteractionDesignFoundation/IDF-web/compare/{{previousRelease}}...develop" target="_blank">Preview changes</a>.
    </p>
    <form @submit.prevent="createRelease">
      ...
      <div class="field">
        ...
        <small>Feel free to change autogenerated text to adopt it for non-developers</small>
      </div>
      <div>
        <button
          type="submit"
          class="button is-success"><b>Start a chain</b>: Create a new git tag & GitHub release ➡︎ Run CI build ➡︎ Deploy (if CI build is green)</button>
      </div>
    </form>
  </section>
</template>
